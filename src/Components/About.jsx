            ...
            <div className="row justify-content-center">
              <div className="col-lg-4 col-md-6 col-sm-6">
                <div className="about-info-item mb-4 mb-lg-0">
                  <h3 className="mb-3"><span className="color-three mr-2 text-md ">01.</span>Our Mission</h3>
              ...
              <div className="col-lg-4 col-md-6 col-sm-6">
                <div className="about-info-item mb-4 mb-lg-0">
                  <h3 className="mb-3"><span className="color-three mr-2 text-md">02.</span>Vission</h3>
                  <p>llum similique ducimus accusamus laudantium praesentium, impedit quaerat, itaque maxime sunt deleniti voluptas distinctio .</p>
                </div>		
              </div>
              <div className="col-lg-4 col-md-6 col-sm-6">
                <div className="about-info-item mb-4 mb-lg-0">
                  <h3 className="mb-3"><span className="color-three mr-2 text-md">03.</span>Our Approach</h3>
                  <p>llum similique ducimus accusamus laudantium praesentium, impedit quaerat, itaque maxime sunt deleniti voluptas distinctio .</p>
                </div>		
              </div>
            </div>
            ...
            <div className="row">
              <div className="col-lg-3 col-md-6 col-sm-6">
                <div className="counter-item text-center mb-5 mb-lg-0">
                  <i className="ti-check color-three text-md" />
              ...
              <div className="col-lg-3 col-md-6 col-sm-6">
                <div className="counter-item text-center mb-5 mb-lg-0">
                  <i className="ti-flag color-three text-md" />
              ...
              <div className="col-lg-3 col-md-6 col-sm-6">
                <div className="counter-item text-center mb-5 mb-lg-0">
                  <i className="ti-layers color-three text-md" />
              ...
              <div className="col-lg-3 col-md-6 col-sm-6">
                <div className="counter-item text-center">
                  <i className="ti-medall color-three  text-md" />
          ...
          <div className="container">
            <div className="row justify-content-center">
              <div className="col-lg-7 text-center">
                <div className="section-title">
                  <span className="h6 color-three">Our Team</span>
            ...
            <div className="row justify-content-center">
              <div className="col-lg-4 col-md-6 col-sm-6">
                <div className="team-item-wrap mb-5">
                  <div className="team-item position-relative">
                    <img loading="lazy" src="images/team/team-1.jpg" alt="team" className="img-fluid w-100" />
              ...
              <div className="col-lg-4 col-md-6 col-sm-6">
                <div className="team-item-wrap mb-5">
                  <div className="team-item position-relative">
                    <img loading="lazy" src="images/team/team-2.jpg" alt="team" className="img-fluid w-100" />
                    <div className="team-img-hover">
                      <ul className="team-social list-inline">
                        <li className="list-inline-item">
                          <a href="" className="facebook"><i className="fab fa-facebook-f" aria-hidden="true" /></a>
              ...
              <div className="col-lg-4 col-md-6 col-sm-6">
                <div className="team-item-wrap mb-5 ">
                  <div className="team-item position-relative">
                    <img loading="lazy" src="images/team/team-3.jpg" alt="team" className="img-fluid w-100" />
                    <div className="team-img-hover">
                      <ul className="team-social list-inline">
                        <li className="list-inline-item">
                          <a href="" className="facebook"><i className="fab fa-facebook-f" aria-hidden="true" /></a>
              ...
              <div className="col-lg-4 col-md-6 col-sm-6">
                <div className="team-item-wrap mb-5 mb-lg-0">
                  <div className="team-item position-relative">
                    <img loading="lazy" src="images/team/team-4.jpg" alt="team" className="img-fluid w-100" />
                    <div className="team-img-hover">
                      <ul className="team-social list-inline">
                        <li className="list-inline-item">
                          <a href="" className="facebook"><i className="fab fa-facebook-f" aria-hidden="true" /></a>
              ...
              <div className="col-lg-4 col-md-6 col-sm-6">
                <div className="team-item-wrap mb-5 mb-lg-0">
                  <div className="team-item position-relative">
                    <img loading="lazy" src="images/team/team-6.jpg" alt="team" className="img-fluid w-100" />
                    <div className="team-img-hover">
                      <ul className="team-social list-inline">
                        <li className="list-inline-item">
                          <a href="" className="facebook"><i className="fab fa-facebook-f" aria-hidden="true" /></a>
              ...
              <div className="col-lg-4 col-md-6 col-sm-6">
                <div className="team-item-wrap mb-5 mb-lg-0 ">
                  <div className="team-item position-relative">
                    <img loading="lazy" src="images/team/team-5.jpg" alt="team" className="img-fluid w-100" />
                    <div className="team-img-hover">
                      <ul className="team-social list-inline">
                        <li className="list-inline-item">
                          <a href="" className="facebook"><i className="fab fa-facebook-f" aria-hidden="true" /></a>
